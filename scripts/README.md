...
**輸出格式：** 每個群組建立獨立目錄 `output/{group-name}/`
...
## 🤖 GitHub Copilot Skill 整合

本專案提供 **developer-assessment** Skill，讓您可以透過自然語言直接分析開發者績效，無需手動執行命令！

### 🎯 使用方式

直接在 GitHub Copilot Chat 中使用自然語言描述您的評估需求：
...
Skill 會依據 **6 大評估維度** 進行分析（總分 100 分）：
...
> 💡 **進階使用**：詳細的 Skill 定義與配置請參考 [.copilot/skills/developer-assessment/SKILL.md](../.copilot/skills/developer-assessment/SKILL.md)
